...
class MyPhotosScreenVC: UIViewController {
...
func getData(tab:Int,refresh:Bool){
    objDashboard.GetPost_MyPhotos(tab: tab, Refresh: refresh, vc: self) { (responce,str)  in
...
extension MyPhotosScreenVC:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            guard let arrPost = objDashboard.typeOfPost_PHOTOS(Index: indexPath.row) else{
                return cell
            }
