...
extension ArtistVC:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tblView.dequeueReusableCell(withIdentifier: "cellid")as! ArtistTblcell
//        cell.clcViewMain.delegate = self
//        cell.clcViewMain.dataSource = self
...
// MARK:- Table cell class  Artist
class ArtistTblcell: UITableViewCell,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout {
    
    
    @IBOutlet weak var clcViewMain: UICollectionView!
    
    @IBOutlet weak var heightContrintsClcMain: NSLayoutConstraint!
    let Kheight:CGFloat = 165
    override func awakeFromNib() {
        ...
        heightContrintsClcMain.constant = ((100/3)*(Kheight+5))+Kheight
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = clcViewMain.dequeueReusableCell(withReuseIdentifier: "cellid", for: indexPath)
